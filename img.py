...
if __name__ == "__main__":
    ...
    dataset_path = 'log-files/InvertedPendulum-v1/Sep-22_13_37'
    ...
    img = Imagination(obs_dim=worker.env_dim[0], acts_dim=worker.env_dim[1], model_path='tf-models/', model='fc',
                      z_dim=2)
